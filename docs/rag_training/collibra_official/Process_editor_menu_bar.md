...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Process/to_process-menu-bar.htm
...
Save the currently opened model, also.
...
Activate the spacer tool.

 

Download the model as an image.
...
Validate the model. This function highlights mandatory fields that have no values.
...
Show the model versions.

 

View the model usage details.
