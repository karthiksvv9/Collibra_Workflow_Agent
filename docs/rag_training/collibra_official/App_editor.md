...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Apps/to_app-editor.htm
...
The page contains useful information about the app, such as the 
name
, 
description
, 
...
You can manage your apps by modifying their properties, the appearance of the app, or by creating and reverting to revisions of the app.
