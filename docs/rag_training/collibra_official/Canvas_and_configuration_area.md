...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Process/to_process-canvas.htm
...
The canvas and configuration area is how you interact with and modify your process. To create your BPMN diagram, drag and drop elements from the shape repository to the canvas.
