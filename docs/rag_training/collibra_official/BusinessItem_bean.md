...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/ExecutionLogic/ref_business-item-bean.htm
...
This beans contains all the information about the current business item. For example, 
${item.id}, ${item.type}
