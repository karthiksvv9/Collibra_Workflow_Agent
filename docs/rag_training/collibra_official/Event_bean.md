...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/ExecutionLogic/ref_event-bean.htm
...
${event.taskId}
 the original workflow task that triggered the event.
${event.workflowDefinition.signifier}
