...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/DesignWorkflows/ta_add-workflow-elements.htm
...
Once you have the start and end events and the optional pool and lanes configured, you can add other elements from the 
Shape repository
 to the canvas and connect them to create your workflow.

You add elements by dragging them from the 
Shape repository
 to the canvas. You connect elements with sequence flows.
...
deploy it
 to Collibra and 
configure it
 by editing the workflow definition settings.
