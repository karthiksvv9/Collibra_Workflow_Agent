...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Process/ref_startevent_start.htm
...
A link to a form that becomes the start form or the workflow.
