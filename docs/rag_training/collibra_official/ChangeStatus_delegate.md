...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/ExecutionLogic/ref_changestatus-delegate.htm
...
The 
ChangeStatus
 delegate changes the state of current business item in the process to a specified target state. The current business item is expected to be a representation.
