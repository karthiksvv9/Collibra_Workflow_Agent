...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/ExecutionLogic/ref_termintake-delegate.htm
...
The 
TermIntake
 delegate takes in new terms in our application. The ID of the created term will put in a workflow variable under the name 
outputCreatedTermId
.
...
The signifier of the term to create.
...
The contents of the definition attribute to be created.

description

N

The contents of the description attribute to be created.

note

N

The contents of the note attribute to be created.

example

N

The contents of the example attribute to be created.

usesrelation

N

The ID of the target term that will be related using the 'uses' relation.
