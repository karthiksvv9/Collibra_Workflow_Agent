...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Process/ref_startevent_signal.htm
...
A reference from the signal definitions of the root model.

Signal expression

An expression resolving to a signal name without needing 
