...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Process/to_shape_repository.htm
...
The 
Shape repository
 provides access to various components for process modeling.

Use the search input at the top of the 
Shape repository
 to quickly find a specific component.

Click  
 to reorganize the display of the 
Shape repository
 components.
