...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowElements/to_basic-config-elements.htm
...
For an extensive manual about using Flowable, see the 
