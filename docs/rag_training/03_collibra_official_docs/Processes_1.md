...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Process/to_processes.htm
...
To navigate to the process view page, in your workspace go to the 
Models
 page and filter the view to show only processes instead of all models.
