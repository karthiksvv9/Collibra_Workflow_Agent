...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Forms/to_forms.htm
...
When you design workflows, you create forms to gather input from users or show them information. You use forms in user tasks and start forms to request a user to perform a manual action for a workflow to progress.

The Workflow Designer uses a JSON-based form definition structure as an output format. The form editor replaces the form properties previously used in the Flowable Eclipse Designer.

For an overview of all forms in a workspace, go to the 
Models
 page and filter the view to show only forms instead of all models.

Page overview

The landing page shows a list of the existing forms.

From the forms view you can:

See all the forms associated with a workspace.
