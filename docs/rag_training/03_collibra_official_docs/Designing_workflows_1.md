...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/DesignWorkflows/to_using-workflow-designer.htm
...
Collibra workflows can be simple processes or a collection of processes, sub-processes and forms. Collibra Platform uses the 
Flowable
 workflow engine for managing its process definitions. Collibra provides a custom web application that you can use to design process definitions. For additional information, consult the 
Flowable documentation
.

After you have created a process definition, you have a ZIP file that is ready to be deployed in Collibra. When you upload a process definition, Collibra creates a corresponding workflow definition that is handled as an asset. After that, you can configure the integration of the uploaded process with Collibra.
