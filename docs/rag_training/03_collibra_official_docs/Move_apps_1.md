...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Apps/ta_move-app.htm
...
You can move apps between workspaces in Workflow Designer by using the 
Move app
...
Actions
 next to the name of the app in the navigation menu.
