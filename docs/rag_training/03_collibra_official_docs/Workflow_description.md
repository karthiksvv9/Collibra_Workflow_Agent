...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowElements/co_workflow-description.htm
...
Workflows
.
The Workflows settings page appears on the 
Definitions
 tab page.
