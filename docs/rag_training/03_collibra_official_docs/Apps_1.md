...
Source: https://developer.collibra.com/workflows/workflow-documentation/Content/Workflows/WorkflowDesigner/Apps/to_apps.htm
...
The 
Apps
 page provides an overview of all apps from a workspace. A workflow app is a package that includes a process model and, optionally, one or more form models, which you can deploy in Collibra or share with other users.
...
View options
 to open the controls for changing how apps are shown:
View: Select 
List view
 or 
Grid view
...
For each app listed on the Apps page, you can click the 
 more icon to access a range of management actions:
...
Deploy: Initiate the process of deploying the current version of the app to your Collibra environment.

Create a 
revision
: Create a new revision of the app, allowing you to make changes without affecting the current version.
